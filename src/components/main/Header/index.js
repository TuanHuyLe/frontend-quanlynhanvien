                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-12 order-1 col-sm-12 order-sm-1 col-md-4 order-md-2 col-lg-6">
                                <div className="logo">
                                    <a href="index.html"><img src="assets/images/logo.png" alt="Logo" className="img-fluid" /></a>
                                </div>
                            </div>
                    ...
                    <div className="container">
                        <nav id="main_nav" className="stellarnav">
                            <ul>
                                ...
                                <li className="mega" data-columns={4}><a href="shop-grid.html"><span>Shop</span></a>
